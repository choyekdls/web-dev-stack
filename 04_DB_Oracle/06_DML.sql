...
-- 모든 컬럼 값을 지정하지 않아서 에러! (DATE 기입 안함)
...
UPDATE USER_02
SET MBTI = 'INTP' -- 모두의 MBTI가 INTP이 되어버림
WHERE MBTI IS NULL;
...
-- EMPLOYEE에서 EMP_NAME이 선동일인 사람의 급여를 7000원, 보너스를 0.2로 변경
UPDATE EMPLOYEE
SET SALARY = 7000,
    BONUS = 0.2
    WHERE EMP_NAME = '선동일';
