...
*/
-- 사원번호(입사일), 사원명, 전화번호, 주민등록번호, 주소, 부서, 직급, 급여, 인센티브, 이메일, 퇴직여부, 퇴사일, 비고
CREATE TABLE EMPLOYEE (
EMP_ID INT (10) NOT NULL, -- 
HIRE_DATE DATE NOT NULL,
EMP_NAME VARCHAR (10) NOT NULL, -- 사원명
DEPT_CODE VARCHAR (20) NOT NULL, -- 부서
JOB_CODE VARCHAR (10) NOT NULL, -- 직급
