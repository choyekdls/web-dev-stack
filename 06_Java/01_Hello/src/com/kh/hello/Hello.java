...
/*
 * 패키지(package)
 * - 폴더를 만들어서 파일을 저장하고 관리하듯이 패키지를 만들어 클래서를 저장하고 관리한다.
 ...
 * - 클래서는 설계도이며, 이를 바탕으로 객체(인스턴스)를 생성해 사용한다.
 * */
public class Hello { // 클래스명은 클래스 파일명과 동일해야 한다.
	...
	public static void main(String[] args) {
		...
		/*
		 * 네이밍 규칙
		 * - 패키지명 : 무조건 소문자로 작성, 회사들 간에 패키지가 서로 중복되지 않도록 회사의 도메인 이름으로 패키지를 만든다.
		 * - 클래스명 : 대문자로 시작, 여러개의 단어가 있을 때에는 단어 앞자리마다 대문자
		 * - 메서드명 : 소문자로 시작, 여러개의 단어가 있을 때에는 단어 앞자리마다 대문자
		 * */
