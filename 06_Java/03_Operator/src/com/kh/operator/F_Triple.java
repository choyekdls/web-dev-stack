...
//		f.method1();
	...
	public void method1() {
		...
		// +) 0인 경우는 0입니다.
		result = number > 0 ? "양수" : number == 0 ? "0 입니다" : "음수"; 
		System.out.println(result);
	}
	
	/*
	 * 문제1
	 * 사용자한테 두 개의 정수값을 입력받아서 두 정수의 곱셈 결과 100보다 크거나 같은 경우, "결과가 100이상입니다. 아닌 경우 "결과가 100보다 작습니다" 출력
	 * */
	public void practice1() {
		System.out.print("첫 번째 정수값 입력해라 > ");
		int num1 = Integer.parseInt(sc.nextLine());
		
		System.out.print("두 번째 정수값 입력해라 > ");
