...
public class Application { // 메인 실행 클래스 (객체 생성 및 테스트)
	 ...
	 * 
	 * 객체 지향 프로그래밍(OOP, Objected_Oriented Programming)
	 ...
	 * O : OCP(Pen/Closed Principle) - 개방 폐쇄 원칙
