...
public class Notebook extends Product {
	...
	public Notebook(String brand, String pCode, String name, int price, String cpu) {
		...
		//super.price = price; // 부모가 private - 직접 접근 절대 불가
		
		// 3. 부모의 setter 메서드를 호출해서 초기화
		// - 부모 클래스에서 setter 메서드를 제공하면 자식 클래스에서 부모의 setter 메서드를 통해 초기화 가능함
