...
public class Application {
	...
	public static void main(String[] args) {
		...
		case 1: 
			...
			if(members.length == 3) {System.out.println("회원 수가 모두 꽉 찼기 때문에 일부 메뉴만 오픈합니다.");
			System.out.println("2. 회원 정보 수정");
			System.out.println("3. 전체 회원 정보 출력");
			System.out.println("9. 끝내기");
			System.out.println("메뉴 번호 > ");
		...
		case 2: 
			...
			for(int i = 0; i < members.length; i++) {
				if (members[0] != null && members[0].getId().equals(id)) {
				    members[0].setName(name);
			        members[0].setPwd(pwd);
			        members[0].setEmail(email);
				} else if (members[1] != null && members[1].getId().equals(id)) {
				    members[1].setName(name);
			        members[1].setPwd(pwd);
			        members[1].setEmail(email);
				} else if (members[2] != null && members[2].getId().equals(id)) {
				    members[2].setName(name);
			        members[2].setPwd(pwd);
			        members[2].setEmail(email);
