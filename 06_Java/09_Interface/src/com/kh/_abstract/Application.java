...
public class Application {
	...
	public static void main(String[] args) {
		...
		Pizza bul = new BulgogiPizza(28000, "뫄뫄피자");
		Pizza potato = new PotatoPizza(30000, "감자도우");
		Pizza pineapple = new PineapplePizza(22000, "진짜싫어");
		
		Pizza[] pizza = {bul, potato, pineapple};
