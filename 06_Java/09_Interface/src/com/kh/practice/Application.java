...
public class Application {
	...
	public void insertEmp() {
		...
		if (addInfo == 'y') {
			// y일 경우만
			System.out.println("직원 전화번호 : ");
			String phone = sc.nextLine();
			System.out.println("직원 주소 : ");
			String addr = sc.nextLine();
			System.out.println("직원 성별 : ");
			String gender = sc.nextLine();
			System.out.println("직원 생일 (예 : 2025-06-23) : "); // LocalDate.parse(문자열) <- 문자열을 날짜로
			String bithDateInput = sc.nextLine();
			LocalDate birthDate = LocalDate.parse(bithDateInput);
			// LocalDate birthDate = LocalDate.parse(sc.nextLine()); 도 가능
//			System.out.println("부서명 : "); // 너무 어렵다면 생략!
