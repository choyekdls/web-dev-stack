...
/*
 * - 컬렉션 : 자바에서 제송하는 자료구조를 담당하는 프레임워크
 * - 자료구조 : 데이터르르 효율적으로 이용하는 방법으로 데이터에 편리하게 접근하고, 효율적으로 사용하기 위해서 데이터를 저장하거나 조직하는 방법
 * - java.util 패키지에 컬렉션과 관련된 인터페이스와 클래스들이 포함
 * - 컬렉션을 사용하면 데어터 추가, 삭제, 정렬 등의 처리가 간단하게 해결되어 자료구조적 알고리즘을 구현할 필요가 없음
 * 
 * 컬렉션의 장점
 * - 저장하는 크기의 제약이 없다
...
public class A_ArrayList {
	 ...
	 * 
	 * * 컬렉션에서 사용하는 이류 -> 명시된 타입의 객체만 저장하도록 제한을 두기 위해
	 */
	...
	public void method3() {
		...
		Collections.sort(list);
		// 11. 내림차순 정렬 : sort 메서드로 오름차순 정렬 후 reverse 로 정렬해야 정확함. 그냥 reverse해버리면 리스트에 입력한
		// 그대로 내림차순 정렬함
