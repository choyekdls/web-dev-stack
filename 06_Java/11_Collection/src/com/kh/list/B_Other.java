...
public class B_Other {
	...
	// 큐(Queue) : 처음에 저장한 것을 제일 먼저 꺼내는 FIFO(First In First Out), 이 넘은 Interface 입니다...(객체 생성이 불가하다는 말~..)
	public void method3() {
		...
		q.offer(2);
		q.offer(3);
		q.poll(); // 데이터 삭제 : 제일 처음 저장된 데이터 삭제
		q.add(4); // 데이터 추가
		q.remove(); //데이터 삭제
		q.add(5);
		q.add(6);
	...
	// Deque - 양 방향, Stack/Queue 둘 다 사용 가능(이 넘도..Interface 입니다...(객체 생성 불가)
	public void method4() {
