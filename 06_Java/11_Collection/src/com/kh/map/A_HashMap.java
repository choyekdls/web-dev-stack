...
public class A_HashMap {
	...
	public void method2() {
		...
		Set<String> snack = map.keySet();
		System.out.println("과자의 개수 : " + snack.size());
		
		// 웨하스의 맛과 칼로리는?
	
		System.out.println(map.get("웨하스"));
		///System.out.println("웨하스 맛 : " + snack.getFlavor() + ", 칼로리 : " + snack.getCalories());
