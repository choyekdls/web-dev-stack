...
public class B_TreeSet { // 정렬 기준이 있어야 한다고..? 가져오는 데이터에 implements 가 되어 있어야함 그래서 override가 되어 있어야 함
	...
	public void method2() {
		...
		/*
		 * Iterator - 컬렉션에 저장된 요소를 접근하는데 사용하는 인터페이스 - iterator()를 호출해서 Iterator 를 구현한
		 * 객체를 얻어서 사용
		 */
		System.out.println("------------------");
