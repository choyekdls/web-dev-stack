...
public class A_String {
	...
	public void method1() {
		...
		String str4 = new String("hello"); // 객체는 생성되는 순간 주소값이 생깁니다..

		System.out.println("str1 == str2 : " + (str1 == str2)); // true
		System.out.println("str3 == str4 : " + (str3 == str4)); // false
		System.out.println("str1 == str3 : " + (str1 == str3)); // false

		// 우리가 equals 를 사용하는 이유.
	...
	public void method2() {
		...
		System.out.println("1. chatAt : " + ch);

		// 2. concat(String str) : String
		// 전달받은 문자열과 원본 문자열을 하나로 합친 새로운 문자열 생성해서 리턴(원 문자열의 뒤에 추가가됩니다...)
		String str2 = str.concat("!!!!!");
		str2 = str + "!!!!!";
		System.out.println("2. concat : " + str2);

		// 3. substring(int beginIndex, int endIndex) : String
		// 문자열의 beginIndex부터 endIndex - 1까지 (endIndex 생략하면 끝까지)의 문자열을 새로 생성해서 리턴
		...
		// 7. trim() : String (개발할 때 많이 보게 된다고 합니다..)
		// 문자열의 앞뒤 공백을 제거한 새로운 문자열을 생성해서 리턴
		String str8 = "                       Hello,                          Java!                                          ";
		System.out.println("8. trim 전 : " + str8);
		String str9 = str8.trim();
		System.out.println("9. trim 후 : " + str9);

		// 8. toCharArray() : chat[]
		// 문자열의 문자들을 문자 배열에 담아서 해당 배열의 주소값 리턴
		char[] arr = str.toCharArray();
		System.out.println("10. toCharArray : " + arr);
	 ...
	 * 16개의 문자를 저장할 수 있는 버퍼가 미리 생상되고 문자가 저정됨에 따라 자동 증가 - StringBuilder : 동기화 X -> 단일
	...
	public void method4() {
		...
		System.out.println("과목 개수 : " + strArr.length); // 꺼내써도 배열에 값이 그대로 담겨져있음

		// 2. StringTokenizer 객체 이용
		StringTokenizer st = new StringTokenizer(str, ",");
		
		// hasMoreTokens : 남아있는 토근이 있는지
		System.out.println(st.hasMoreTokens());
		// nextToken : 토큰을 하나씩 꺼내옴
		while(st.hasMoreTokens()) {
		System.out.println(st.nextToken());}
		System.out.println("과목 개수 : " + st.countTokens());// 꺼내쓰면 값이 사라짐..있었는데..? 없었습니다..
