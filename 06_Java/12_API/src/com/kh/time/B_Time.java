...
public class B_Time {
	...
	public void method1() {
		...
		// ZonedDateTime : LocalDateTime + 시간대 (현재 위치까지 보여줌)
		System.out.println("ZonedDateTime : " + ZonedDateTime.now());

		// 년, 월, 일, 요일, 시, 분, 초
		System.out.println(now.getYear() + "년");
		System.out.println(now.getMonthValue() + "월"); // getMonth는 JUNE 영어로 뜹니다..
		...
		localTime = LocalTime.of(17, 49, 16);
		System.out.println("LocalTime 2 : " + localTime);
	}

	/*
	 * Period 와 Duration - 날짜와 시간 간격을 표현하기 위한 클래스 - Period : 두 날짜 간의 차이(기간 -
	 * Duration : 시간의 차이(시간
	 */
	...
	/*
	 * D-Day 계산기 ChronoUnit.DAYS.between(날짜, 날짜) 또는 날짜.until(날짜, ChronoUnit.DAYS)
	 */
	public void method3() {
