...
public class DispatcherServlet extends HttpServlet {
	...
	/*
	 * Controller 에서 Servlet 을 하나로 만들자! Front Controller Pattern
	 * 
	 * 소프트웨어 디자인 패턴 중 하나로 웹 애플리케이션 등에서 사용되는 패턴 중 하나 애플리케이션의 진입점을 중앙집중화 하여 요청을 처리하고,
	 * 전체적인 흐름을 제어하는 역할
	 * 
	 * - Dispatcher Servlet 은 자바 기반은 웹 애플리케이션에서 FrontControllerPattern을 구현하는데 사용되는
	 * 핵심 컴포넌트 - SpringFramwork와 관련된 개념으로 많이 사용되는데 SpringMVC의 일부로 동작하며 웹 요청을 받아서 적절한
